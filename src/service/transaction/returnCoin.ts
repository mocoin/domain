...
): IStartOperation<factory.transaction.returnCoin.ITransaction> {
    return async (repos: {
        action: ActionRepo;
        bankAccountPayment: BankAccountPaymentRepo;
        coinAccount: CoinAccountRepo;
...
export function confirm(params: {
    ...
    return async (repos: {
        ...
        // 取引存在確認
        const transaction = await repos.transaction.findById(factory.transactionType.ReturnCoin, params.transactionId);
