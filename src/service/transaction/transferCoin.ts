...
export function start(
    ...
    return async (repos: {
        ...
        // 残高確認
        switch (transaction.object.fromLocation.typeOf) {
            case 'PaymentMethod':
                switch (transaction.object.fromLocation.paymentMethodType) {
                    case factory.paymentMethodType.BankAccount:
        ...
        // 入金確認
        switch (transaction.object.toLocation.typeOf) {
            case 'PaymentMethod':
                switch (transaction.object.toLocation.paymentMethodType) {
                    case factory.paymentMethodType.BankAccount:
                        // await authorizeWithdrawBankAccount(transaction)(repos);
                        break;
